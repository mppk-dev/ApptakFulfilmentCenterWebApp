...
public partial class PfzInvoicesHead
{
    ...
    public int? FocrequestProduct { get; set; }

    public int? FocrequestQuantity { get; set; }

    public DateTime? CreatedDate { get; set; }

    public virtual ICollection<PfzInvoicesHeadDetail> PfzInvoicesHeadDetails { get; set; } = new List<PfzInvoicesHeadDetail>();
}
